import { a as zt, x as x$1, g as gt, k as ke, R as Re, v as vs } from "./indexhtml-BZBCy2ek.js";
import { g } from "./state-DOkKKpWv-DVftGsab.js";
import { b, p } from "./overlay-monkeypatch-tiv0Sndr-BSEA2H-v.js";
import { o as o$1 } from "./base-panel-BWfqXAMS-BrLfFEXa.js";
...
let i = class extends o$1 {
  ...
  renderFooter() {
    return this.message === void 0 ? zt`
          <div class="dialog-footer">
            <vaadin-button
              theme="tertiary"
              @click="${() => x$1.emit("system-info-with-callback", {
  ...
  close() {
    gt.updatePanel("copilot-feedback-panel", {
      floating: false
    });
  }
  submit() {
    ...
    x$1.emit("system-info-with-callback", {
