import { x as x$1, z as zr, E as El, b as b$1, U as Ur, v as vs, T as Ts, m as be, g as gt$1, V as Vl, n as ie, o as fs, q as ql, D as Dl, p as Qi, a as zt$1, J as Je, X as Xl, P as Pl, O, t as Jl, Z as Zl, d as Ls, w as bl, A as pl, L as Ll } from "./indexhtml-BZBCy2ek.js";
import { g as g$1, h } from "./state-DOkKKpWv-DVftGsab.js";
import { p as p$1, b as b$2 } from "./overlay-monkeypatch-tiv0Sndr-BSEA2H-v.js";
import { r as r$1 } from "./icons-DpnnuXfg-E8O83Wvc.js";
import { z, V } from "./react-utils-D_MlSXfo-UoRpHi8k.js";
import { showNotification as N$1, dismissNotification as m$1 } from "./copilot-notification-CUWNmpXC-kpIRXL4B.js";
/**
 * @license
...
let b = class extends Ts {
  constructor() {
    super(...arguments), this.position = "right", this.opened = false, this.keepOpen = false, this.resizing = false, this.closingForcefully = false, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
      ...
      t.stopPropagation(), t.preventDefault(), requestAnimationFrame(() => {
        ...
        gt$1.panels.filter((i) => !i.floating && i.panel === this.position).forEach((i) => {
          gt$1.updatePanel(i.tag, n);
        });
      });
    }, this.sectionPanelDraggingStarted = (t, e) => {
      this.draggingSectionPanel = t, x$1.emit("user-select", { allowSelection: false }), this.draggingSectionPointerStartY = e.clientY, t.toggleAttribute("dragging", true), t.style.zIndex = "1000", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((o, n) => {
        o.setAttribute(B, `${n}`);
      ...
      if (!this.draggingSectionPanel)
        return;
      x$1.emit("user-select", { allowSelection: true });
      ...
      this.cleanUpDragging(), gt$1.updateOrders(t), document.removeEventListener("mouseup", this.sectionPanelDraggingFinished), document.removeEventListener("mousemove", this.sectionPanelDragging);
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      (e) => {
        e === ql.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
      () => gt$1.getAttentionRequiredPanelConfiguration(),
      () => {
        const e = gt$1.getAttentionRequiredPanelConfiguration();
        e && !e.floating && this.toggleAttribute(Dl, e.panel === this.position);
      }
    ), this.reaction(
      () => b$1.active,
      () => {
      ...
      this.resizing = false, b$1.setDrawerResizing(false), this.removeAttribute("resizing"), x$1.emit("user-select", { allowSelection: true });
    });
    const t = be.getDrawerSize(this.position);
    t && this.style.setProperty("--size", `${t}px`), document.addEventListener("mousemove", this.resizingMouseMoveListener), this.addEventListener("mouseenter", this.mouseEnterListener), x$1.on("document-activation-change", (e) => {
  ...
  firstUpdated(t) {
    super.firstUpdated(t), requestAnimationFrame(() => this.toggleAttribute("no-transition", false)), this.resizeElement.addEventListener("mousedown", (e) => {
      e.button === 0 && (this.resizing = true, b$1.setDrawerResizing(true), this.setAttribute("resizing", ""), x$1.emit("user-select", { allowSelection: false }));
    });
  }
  updated(t) {
    super.updated(t), t.has("opened") && this.opened && this.hasAttribute(Dl) && (this.removeAttribute(Dl), gt$1.clearAttention()), this.updateScrollable();
  }
...
class bt {
  ...
  adjust(e, o, n, i, r) {
    ...
    return (i + o) / 2 < k / 2 ? (e.style.setProperty("--left", `${o}px`), e.style.setProperty("--right", ""), P = void 0, s = Math.max(0, o)) : (e.style.removeProperty("--left"), e.style.setProperty("--right", `${k - i}px`), s = void 0, P = Math.max(0, k - i)), (n + r) / 2 < C / 2 ? (e.style.setProperty("--top", `${n}px`), e.style.setProperty("--bottom", ""), h2 = void 0, c = Math.max(0, n)) : (e.style.setProperty("--top", ""), e.style.setProperty("--bottom", `${C - r}px`), c = void 0, h2 = Math.max(0, C - r)), {
      left: s,
      right: P,
      top: c,
      bottom: h2
...
let T = class extends Ts {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = false, this.mouseDownListener = (t) => {
      ...
      const t = gt$1.getAttentionRequiredPanelConfiguration();
      return t ? t.panel && !t.floating ? (x$1.emit("open-attention-required-drawer", null), true) : (gt$1.clearAttention(), true) : false;
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      () => gt$1.attentionRequiredPanelTag,
      () => {
        this.toggleAttribute(Dl, gt$1.attentionRequiredPanelTag !== null);
      }
    ), this.reaction(
      () => b$1.active,
      () => {
    ...
    t ? (this.style.setProperty("--left", `${t.left}px`), this.style.setProperty("--bottom", `${t.bottom}px`), this.style.setProperty("--right", `${t.right}px`), this.style.setProperty("--top", `${t.top}px`)) : (this.style.setProperty("--bottom", "var(--space)"), this.style.setProperty("--right", "var(--space)")), x$1.on("document-activation-change", (e) => {
      this.toggleAttribute("document-hidden", !e.detail.active);
    });
  }
  disconnectedCallback() {
  ...
  handleMenuItemClick(t) {
    switch (t.action) {
      ...
      case "undo":
      case "redo":
        x$1.emit("undoRedo", { undo: t.action === "undo" });
        break;
      case "feedback":
        gt$1.updatePanel("copilot-feedback-panel", {
          floating: true
        });
        break;
      case "welcome":
        ...
        break;
      case "shortcuts":
        gt$1.updatePanel("copilot-shortcuts-panel", {
          floating: true
        });
        break;
    }
...
let w = class extends Ts {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      if (o < s ? i < s ? (c = "nw-resize", this.setAttribute(g, "top left")) : r < s ? (c = "sw-resize", this.setAttribute(g, "bottom left")) : (c = "col-resize", this.setAttribute(g, "left")) : n < s ? i < s ? (c = "ne-resize", this.setAttribute(g, "top right")) : r < s ? (c = "se-resize", this.setAttribute(g, "bottom right")) : (c = "col-resize", this.setAttribute(g, "right")) : r < s ? (c = "row-resize", this.setAttribute(g, "bottom")) : i < s && (c = "row-resize", this.setAttribute(g, "top")), c !== "") {
        const h2 = window.getComputedStyle(this), P = Number.parseInt(h2.borderTopWidth, 10), k = Number.parseInt(h2.borderTopWidth, 10), C = Number.parseInt(h2.borderLeftWidth, 10), J = Number.parseInt(h2.borderRightWidth, 10);
      ...
      this.hasAttribute(_) && t.button === 0 && (t.stopPropagation(), t.preventDefault(), m.anchorLeftTop(this), this.floatingResizingStarted = true, this.toggleAttribute("resizing", true), Pl(() => {
      ...
      if (!this.floatingResizingStarted || !this.panelInfo?.floating)
        return;
      t.stopPropagation(), t.preventDefault(), this.floatingResizingStarted = false, Pl(() => {
      ...
      gt$1.updatePanel(this.panelInfo.tag, {
        width: e,
        height: o - (h2 + P),
        floatingPosition: {
      ...
      t.button === 0 && (this.resizingInDrawerStarted = true, this.setAttribute("resizing", ""), x$1.emit("user-select", { allowSelection: false }));
      ...
      this.style.setProperty("--section-height", `${o}px`), gt$1.updatePanel(this.panelInfo.tag, {
        height: o
      });
    }, this.resizeInDrawerMouseUpListener = () => {
      this.resizingInDrawerStarted && (this.panelInfo?.floating || (this.resizingInDrawerStarted = false, this.removeAttribute("resizing"), x$1.emit("user-select", { allowSelection: true }), this.style.setProperty("--section-height", `${this.getBoundingClientRect().height}px`)));
    }, this.sectionPanelMouseEnterListener = () => {
      this.hasAttribute(Dl) && (this.removeAttribute(Dl), gt$1.clearAttention());
    }, this.contentAreaMouseDownListener = () => {
      gt$1.addFocusedFloatingPanel(this.panelInfo);
      ...
      t.button === 0 && (gt$1.addFocusedFloatingPanel(this.panelInfo), !this.hasAttribute(g) && (t.target instanceof HTMLButtonElement && t.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(t) : this.startDragging(t)));
      ...
      const t = gt$1.getPanelByTag(this.panelTag);
      ...
      if (!this.panelInfo)
        return O;
      let t;
      return this.panelInfo.panel === void 0 ? t = "Close the popup" : t = this.panelInfo.floating ? `Dock ${this.panelInfo.header} to ${this.panelInfo.panel}` : `Open ${this.panelInfo.header} as a popup`, zt$1`
    ...
    `;
      ...
      if (this.panelInfo)
        if (t.stopPropagation(), Jl(this), this.panelInfo?.floating)
          gt$1.updatePanel(this.panelInfo?.tag, { floating: false });
        else {
          let e;
          ...
          o === void 0 && this.panelInfo.expanded && (o = Number.parseInt(window.getComputedStyle(this).height, 10)), this.parentElement.forceClose(), gt$1.updatePanel(this.panelInfo?.tag, {
            floating: true,
      ...
      this.panelInfo && (t.stopPropagation(), m.anchorLeftTop(this), gt$1.updatePanel(this.panelInfo.tag, {
  ...
  connectedCallback() {
    super.connectedCallback(), this.setAttribute("role", "region"), this.reaction(
      ...
      () => {
        const t = gt$1.getAttentionRequiredPanelConfiguration();
        this.toggleAttribute(Dl, t?.tag === this.panelTag && t?.floating);
      }
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            b$1.operationInProgress === ql.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
      () => gt$1.floatingPanelsZIndexOrder,
      () => {
        this.style.setProperty("--z-index-focus", `${gt$1.getFloatingPanelZIndex(this.panelTag)}`);
      },
      { fireImmediately: true }
  ...
  willUpdate(t) {
    super.willUpdate(t), t.has("panelTag") && (this.panelInfo = gt$1.getPanelByTag(this.panelTag), this.setAttribute("aria-labelledby", this.panelInfo.tag.concat("-title"))), this.toggleAttribute("floating", this.panelInfo?.floating);
  }
  updated(t) {
  ...
  render() {
    return this.panelInfo ? zt$1`
      <div part="container">
        <div part="header" class="drag-handle">
          ${this.panelInfo.expandable !== false ? zt$1` <button
                part="toggle-button"
  ...
  renderHelpButton() {
    return this.panelInfo?.helpUrl ? zt$1` <button
  ...
  changeDockingPanel(t) {
    ...
    if (this.panelInfo?.panel !== e) {
      const o = gt$1.panels.filter((n) => n.panel === e).map((n) => n.panelOrder).sort((n, i) => i - n)[0];
      Jl(this), gt$1.updatePanel(this.panelInfo.tag, { panel: e, panelOrder: o + 1 });
    }
...
w = I([
  vs("copilot-section-panel-wrapper")
], w);
x$1.on("undoRedo", (t) => {
  const o = { files: t.detail.files ?? z(), uiId: V() }, n = t.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo";
  x$1.send(n, o);
});
var kt = (t, e, o, n) => {
...
let Y = class extends Ts {
  ...
  render() {
    return zt$1`<div class="notification-tray">
      ...
      <div
        ...
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!t.details && !t.link}">
            ${Ll(t.details)}
            ${t.link ? zt$1`<a class="ahreflike" href="${t.link}" target="_blank">Learn more</a>` : ""}
          </div>
          ${t.dismissId ? zt$1`<div
...
Y = kt([
  vs("copilot-notifications-container")
], Y);
function Ct(t) {
...
const K = El(() => {
  x$1.emit("component-tree-updated", {});
});
x$1.on("vite-after-update", () => {
  K();
});
